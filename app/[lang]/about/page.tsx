...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return { title: dict.meta.aboutTitle, description: dict.meta.aboutDescription, alternates: alternatesFor(locale, "/about") };
}

export default async function AboutPage() {
  const { dict, content } = await getI18n();
  const d = dict.aboutPage;
  const { company, customers, images, apc } = content;
  const reasons = content.whyRight;
  return (
    <>
      <PageHero
        crumbs={[{ label: dict.common.home, href: "/" }, { label: dict.common.about }]}
        eyebrow={d.eyebrow}
        title={
          <>
            {d.title1}
        ...
        size="lg"
        specs={[
          { label: d.specFounded, value: "1990s" },
          { label: d.specTeam, value: d.specTeamValue },
          { label: d.specExperience, value: d.specExperienceValue },
          { label: d.specFacility, value: d.specFacilityValue },
        ]}
      />
      ...
      <section aria-labelledby="who" className="bg-paper py-16 lg:py-28">
        <div className="container-x grid gap-12 lg:grid-cols-12 lg:gap-16">
          <div className="lg:col-span-7">
            <SectionHeader compact index="01" label={d.whoLabel} id="who" title={d.whoTitle} />
            <Reveal className="mt-8 space-y-5 text-[1.05rem] leading-relaxed text-steel">
              ...
              <p className="border-s-2 border-blue ps-5 text-navy">
                {d.vision}
              </p>
            </Reveal>
          </div>
          <Reveal delay={100} className="lg:col-span-5">
            ...
            <dl className="mt-px grid grid-cols-2 gap-px bg-navy/15">
              {[
                { v: 98, s: "%", l: d.retention },
                { v: 10000, d: "10K", s: "+", l: d.parts },
              ].map((x) => (
      ...
      <section id="why-right" aria-labelledby="why" className="scroll-mt-20 bg-ink py-16 text-white lg:py-28">
        <div className="container-x">
          <SectionHeader tone="dark" index="02" label={d.whyLabel} id="why" title={d.whyTitle} />
      ...
      <section aria-labelledby="lead" className="bg-paper py-16 lg:py-24">
        <div className="container-x grid gap-12 lg:grid-cols-12">
          <div className="lg:col-span-5">
            <SectionHeader compact index="03" label={d.leadLabel} id="lead" title={d.leadTitle} />
          </div>
      ...
      <section aria-labelledby="partner" className="bg-mist py-16 lg:py-24">
        <div className="container-x grid items-center gap-10 lg:grid-cols-12">
          ...
          <div className="lg:col-span-6">
            <SectionHeader compact index="04" label={d.partnerLabel} id="partner" title={t(d.partnerTitle, { years: apc.years })} />
